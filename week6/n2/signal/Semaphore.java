...
public final class Semaphore {
    ...
    private int limit; //Anzahl der gleichzeitigen Zugriffe
     ...
     * @throws java.lang.InterruptedException falls das Warten unterbrochen
     * wird.
     * @return macht nur einen exit aus der Methode wenn die Anzahl permits gleichzeitig frei sind.
     */
    public synchronized void acquire(final int permits) throws InterruptedException {
        while (sema < permits) {
            throw new IllegalArgumentException("not enough semaphores available");
        }
        sema -= permits;
    }
